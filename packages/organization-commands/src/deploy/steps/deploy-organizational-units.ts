...
export const deployOrganizationalUnits: DeployOrganizationStep<PoliciesDeploymentResultHolder> =
  async (state) => {
    const {
      transitions,
      ctx,
    ...
    const serviceControlPoliciesJustEnabled =
      basicConfigPlan.enabledPolicies.add.includes("SERVICE_CONTROL_POLICY")
