...
export const AI_SERVICES_OPT_OUT_POLICY_MAX_SIZE_IN_CHARACTERS = 2500
export const BACKUP_POLICY_MAX_SIZE_IN_CHARACTERS = 10000
...
export const SERVICE_CONTROL_POLICY_TYPE: PolicyType = "SERVICE_CONTROL_POLICY"
export const TAG_POLICY_TYPE: PolicyType = "TAG_POLICY"
export const BACKUP_POLICY_TYPE: PolicyType = "BACKUP_POLICY"
export const AISERVICES_OPT_OUT_POLICY_TYPE: PolicyType =
