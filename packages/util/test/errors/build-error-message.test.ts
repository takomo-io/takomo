import { buildErrorMessage } from "../../src/errors/build-error-message"
  ...
  describe("when a plain error without detailed information is given", () => {
    test.concurrent(
      ...
      () => {
        ...
        expect(buildErrorMessage(description, contents, error(message))).toBe(
          expected,
        )
      },
    )
  ...
  describe("when an error with detailed information with different start and end line numbers is given", () => {
    test.concurrent(
      ...
      () => {
        ...
        expect(buildErrorMessage(description, contents, err)).toBe(expected)
      },
    )
  })
